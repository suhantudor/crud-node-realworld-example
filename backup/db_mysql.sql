...
-- Script date 8/11/2022 1:56:16 PM
...
--
-- Table db_mysql.users does not contain any data (it is empty)

-- 
-- Dumping data for table devices
--
-- Table db_mysql.devices does not contain any data (it is empty)
